            ...
            {quiz.settings.executionMode === 'teacher-controlled' && (
              <div className="flex items-center justify-center space-x-2 mt-3">
                <div className="flex space-x-1">
                  ...
                  <div className="w-2 h-2 bg-primary-400 rounded-full animate-bounce-delay-1"></div>
                  <div className="w-2 h-2 bg-primary-400 rounded-full animate-bounce-delay-2"></div>
                </div>
